<section class="content-header">
    <h1>
        <?php echo __('Cliente Emails'); ?>
        <small><?php echo __('All Registered'); ?></small>
    </h1>
    <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Cliente Emails'));
            echo $this->Html->getCrumbList(['class'=>'breadcrumb','lastClass'=>'active']);?>
    
</section>
<div class="clienteEmails index" style="margin: 20px" >
        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	...
                	<tbody>
                	    <tr>
                    	    <?php $base_url = array('controller' => 'Cliente Emails', 'action' => 'index');?>
...
<td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
                		...
                		<?php foreach ($clienteEmails as $clienteEmail): ?>
						<tr>
						<td><?php echo h($clienteEmail['ClienteEmail']['IdCliente']); ?>&nbsp;</td>
						<td><?php echo h($clienteEmail['ClienteEmail']['Email']); ?>&nbsp;</td>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $clienteEmail['ClienteEmail']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $clienteEmail['ClienteEmail']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $clienteEmail['ClienteEmail']['id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $clienteEmail['ClienteEmail']['id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
