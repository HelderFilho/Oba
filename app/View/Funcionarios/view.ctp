...
<?php if($funcionario['Funcionario']['Caracteristicas']){?>
        <dt><?php echo __('Caracteristicas'); ?></dt>
        <dd><?php echo h($funcionario['Funcionario']['Caracteristicas']); ?></dd>
        <?php }?>
		...
		<?php }?>
        <?php if($funcionario['Funcionario']['Equipe']){?>
        <dt><?php echo __('Equipe'); ?></dt>
        <dd><?php echo h($funcionario['Funcionario']['Equipe']); ?></dd>
        <?php }?>
        <?php if($funcionario['Funcionario']['Tipo']){?>
        <dt><?php echo __('Tipo'); ?></dt>
        <dd><?php echo h($funcionario['Funcionario']['Tipo']); ?></dd>
        <?php }?>
		...
		<?php }?>
        <?php if($funcionario['Funcionario']['Item_Novo']){?>
        <dt><?php echo __('Item Novo'); ?></dt>
        <dd><?php echo h($funcionario['Funcionario']['Item_Novo']); ?></dd>
        <?php }?>
        <?php if($funcionario['Funcionario']['Data_Nascimento']){?>
        <dt><?php echo __('Data de Nascimento'); ?></dt>
        <dd><?php echo h($funcionario['Funcionario']['Data_Nascimento']); ?></dd>
        <?php }?>
