<section class="content-header">
    ...
    <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Revisors'),'/Revisors');
...
<div class="panel panel-default" style="margin: 20px">
    ...
    <div class="nav-tabs-custom">
		...
		<?php if($revisor['Revisor']['Id']){?>
		<dt><?php echo __('Id'); ?></dt>
		<dd><?php echo h($revisor['Revisor']['Id']); ?></dd>
		<?php }?>
		...
		<?php }?>
		<?php if($revisor['Revisor']['Removed']){?>
		<dt><?php echo __('Removed'); ?></dt>
		<dd><?php echo h($revisor['Revisor']['Removed']); ?></dd>
		<?php }?>
		<?php if($revisor['Revisor']['Created']){?>
		<dt><?php echo __('Created'); ?></dt>
		<dd><?php echo h($revisor['Revisor']['Created']); ?></dd>
		<?php }?>
		<?php if($revisor['Revisor']['Modified']){?>
		<dt><?php echo __('Modified'); ?></dt>
		<dd><?php echo h($revisor['Revisor']['Modified']); ?></dd>
		<?php }?>
                </div>
            </div>
                        </div>
