<section class="content-header">
    ...
    <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Equipe P D Vs'));
            echo $this->Html->getCrumbList(['class'=>'breadcrumb','lastClass'=>'active']);?>
    
</section>
<div class="equipePDVs index" style="margin: 20px" >
                	...
                	<thead>
                	   <tr>
                    	<th><?php echo $this->Paginator->sort('Id',__('Id'),array('data-toggle'=>'tooltip','data-original-title'=>__('Id'),'title'=>__('Id'))); ?></th>
                            ...
                            <th><?php echo $this->Paginator->sort('EquipesPDVcol',__('EquipesPDVcol'),array('data-toggle'=>'tooltip','data-original-title'=>__('EquipesPDVcol'),'title'=>__('EquipesPDVcol'))); ?></th>
                            <th class="actions col-xs-1"><?php echo __('Actions'); ?></th>
                	   </tr>
                	</thead>
                	<tbody>
                	    <tr>
                    	    <?php $base_url = array('controller' => 'Equipe P D Vs', 'action' => 'index');?>
					 ...
					 <td><?php echo $this->Html->div('row',$this->Form->input('EquipesPDVcol',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('EquipesPDVcol'),'title'=>__('EquipesPDVcol'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
<td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
                		...
                		<?php foreach ($equipePDVs as $equipePDV): ?>
						<tr>
						<td><?php echo h($equipePDV['EquipePDV']['Id']); ?>&nbsp;</td>
						<td><?php echo h($equipePDV['EquipePDV']['Nome']); ?>&nbsp;</td>
						<td><?php echo h($equipePDV['EquipePDV']['Empresa']); ?>&nbsp;</td>
						<td><?php echo h($equipePDV['EquipePDV']['Removed']); ?>&nbsp;</td>
						<td><?php echo h($equipePDV['EquipePDV']['Created']); ?>&nbsp;</td>
						<td><?php echo h($equipePDV['EquipePDV']['Modified']); ?>&nbsp;</td>
						<td><?php echo h($equipePDV['EquipePDV']['EquipesPDVcol']); ?>&nbsp;</td>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $equipePDV['EquipePDV']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $equipePDV['EquipePDV']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $equipePDV['EquipePDV']['Id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $equipePDV['EquipePDV']['Id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
