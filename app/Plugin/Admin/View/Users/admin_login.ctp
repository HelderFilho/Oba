...
<div class="row">
	<div class="col-md-4 col-md-offset-4">
		...
		<center>
		<?php echo $this->Html->image('Logo_oba_top.png',array('style' => 'width:300px','alt'=>'PAGTRAN','title'=>'PAGTRAN','id'=>'imgClient'))?>
		</center>
			...
			<?php
			   ...
			   ?>
			<?php echo $this->Form->end(array('label' => __d('admin', 'Login'), 'class' => 'login btn btn-lg btn-primary btn-block')); 
