<section class="content-header">
    <h1>
        ...
        <small><?php echo __('Edit').' '.__('Cliente Email'); ?></small>
    </h1>
     <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Cliente Emails'),'/Cliente Emails');
              $this->Html->addCrumb(__('Edit').' '.__('Cliente Email'));
            echo $this->Html->getCrumbList(['class'=>'breadcrumb','lastClass'=>'active']);?>
</section>
<div class="clienteEmails form" style="margin: 20px" >
<?php echo $this->Form->create('ClienteEmail'); ?>
    <fieldset>
