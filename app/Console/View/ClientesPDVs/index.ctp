<section class="content-header">
    ...
    <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Clientes P D Vs'));
        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	...
                	<tbody>
                	    <tr>
                    	    <?php $base_url = array('controller' => 'Clientes P D Vs', 'action' => 'index');?>
...
<td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
                		...
                		<?php foreach ($clientesPDVs as $clientesPDV): ?>
						<tr>
						<td><?php echo h($clientesPDV['ClientesPDV']['Id']); ?>&nbsp;</td>
						<td><?php echo h($clientesPDV['ClientesPDV']['CNPJ']); ?>&nbsp;</td>
						<td><?php echo h($clientesPDV['ClientesPDV']['Razao_Social']); ?>&nbsp;</td>
						<td><?php echo h($clientesPDV['ClientesPDV']['Nome_Fantasia']); ?>&nbsp;</td>
						<td><?php echo h($clientesPDV['ClientesPDV']['Endereco']); ?>&nbsp;</td>
						<td><?php echo h($clientesPDV['ClientesPDV']['Email']); ?>&nbsp;</td>
						<td><?php echo h($clientesPDV['ClientesPDV']['Telefone']); ?>&nbsp;</td>
						<td><?php echo h($clientesPDV['ClientesPDV']['Empresa']); ?>&nbsp;</td>
						<td><?php echo h($clientesPDV['ClientesPDV']['Bairro']); ?>&nbsp;</td>
						<td><?php echo h($clientesPDV['ClientesPDV']['Cep']); ?>&nbsp;</td>
						<td><?php echo h($clientesPDV['ClientesPDV']['Cidade']); ?>&nbsp;</td>
						<td><?php echo h($clientesPDV['ClientesPDV']['Removed']); ?>&nbsp;</td>
						<td><?php echo h($clientesPDV['ClientesPDV']['Created']); ?>&nbsp;</td>
						<td><?php echo h($clientesPDV['ClientesPDV']['Modified']); ?>&nbsp;</td>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $clientesPDV['ClientesPDV']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $clientesPDV['ClientesPDV']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $clientesPDV['ClientesPDV']['Id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $clientesPDV['ClientesPDV']['Id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
