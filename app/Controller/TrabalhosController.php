 ...
 */
	public function index() {
		...
		$options = array('Trabalho.Situacao' => 'Ativo');
	...
	public function todos(){
		        ...
		        return $this->Trabalho->find('all', array('Trabalho.Situacao'=>'Ativo' ));
 ...
 */
   ...
   $Trabalhador = $this->Trabalho->find('first', array(
        'conditions' => array('Trabalho.Funcionarios' => $this->request->data['Trabalho']['Funcionarios'], 'Situacao'=>'Ativo')));



                if (!$Trabalhador==null){
					$this->request->allowMethod('post', 'put');
	   				$data =	$this->Trabalho->set(array('Id'=>$Trabalhador['Trabalho']['Id'], 'Local'=>$this->request->data['Trabalho']['Local'], 'Situacao'=>$this->request->data['Trabalho']['Situacao']));
 ...
 */
	public function delete($id = null) {
		$this->Trabalho->id = $id;
	    $this->Trabalho->set(array('Id'=>$id, 'Removed'=>'S'));

		if (!$this->Trabalho->exists()) {
			throw new NotFoundException(__('Invalid trabalho'));
		}
		$data = array('id' => $id, 'Situacao' => 'Não ativo');
