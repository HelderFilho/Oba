...
<?php
  ...
  $fpdf->SetFont('Arial','',10);
    foreach ($Clientes as $cliente) {
        $fpdf->Cell(31, 10, $cliente['Cliente']['CNPJ'],1);
        $fpdf->Cell(32, 10, $cliente['Cliente']['Nome_Fantasia'],1);
        $fpdf->Cell(32, 10, $cliente['Cliente']['Razao_Social'],1);
        $fpdf->Cell(32, 10, $cliente['Cliente']['Endereco'],1);
        $fpdf->Cell(31, 10, $cliente['Cliente']['Telefone'],1);
        $fpdf->Cell(32, 10, $cliente['Cliente']['Email'],1);
        $fpdf->Ln();
      # code...
    }
    ob_get_clean();
