          ...
          <table>
              <tr>
                 <td class="tamanhoDuplo"> <?php   echo $this->Html->div('row',$this->Form->input('Cliente',
                  ...
                  <td > <?php echo $this->Html->link($this->Html->tag('button', $this->Html->tag('i', 'Gerar Relatório em EXCEL', array('class' => 'relatorio')), array('class' => 'relatorio','data-toggle'=>'tooltip','data-original-title'=>__('Gerar Relatório em EXCEL'),'title'=>__('Gerar Relatório em EXCEL'),'escape' => false)), $this->Html->url(array('controller'=>'Relatorios', 'action' => 'ExportaExcel')), array('escape' => false)); ?> </td>
