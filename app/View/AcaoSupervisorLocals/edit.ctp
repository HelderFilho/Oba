<section class="content-header">
    <h1>
        ...
        <small><?php echo __('Edit').' '.__('Acao Supervisor Local'); ?></small>
    </h1>
     <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Acao Supervisor Locals'),'/Acao Supervisor Locals');
              $this->Html->addCrumb(__('Edit').' '.__('Acao Supervisor Local'));
            echo $this->Html->getCrumbList(['class'=>'breadcrumb','lastClass'=>'active']);?>
</section>
<div class="acaoSupervisorLocals form" style="margin: 20px" >
<?php echo $this->Form->create('AcaoSupervisorLocal'); ?>
    <fieldset>
            ...
            <div class="row">
                <div class="div'=>'col-sm-12 col-md-7 col-xs-12">
                    <div style="margin: 20px">
					 ...
					 echo $this->Html->div('row',$this->Form->input('IdSupervisor',array('div'=>'col-xs-12','data-toggle'=>'tooltip','data-original-title'=>__('IdSupervisor'),'title'=>__('IdSupervisor'),'class'=>'form-control input-sm')),array('escape'=>false));
