                ...
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                    <thead>
                       <tr>
                            ...
                            <th style= text-align:center><?php echo $this->Paginator->sort('Tipo',__('Tipo'),array('data-toggle'=>'tooltip','data-original-title'=>__('Tipo'),'title'=>__('Tipo'))); ?></th>
                    ...
                    <tbody>
                        <tr>
                            <?php $base_url = array('controller' => 'FuncionariosPDVs', 'action' => 'index');?>
                     ...
                     <td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
                        ...
                        <tr>
                        <td><?php echo h($funcionario['FuncionariosPDV']['Nome']); ?>&nbsp;</td>
                        <td><?php echo h($funcionario['FuncionariosPDV']['Endereco']); ?>&nbsp;</td>
                        <td><?php echo h($funcionario['FuncionariosPDV']['Equipe']); ?>&nbsp;</td>
                        <td><?php echo h($funcionario['FuncionariosPDV']['Tipo']); ?>&nbsp;</td>
                        <td><?php echo h($funcionario['FuncionariosPDV']['Email']); ?>&nbsp;</td>
                        <td><?php echo h($funcionario['FuncionariosPDV']['Telefone']); ?>&nbsp;</td>
                        <td><?php echo h($funcionario['FuncionariosPDV']['CPF']); ?>&nbsp;</td>
                        <td><?php echo h($funcionario['FuncionariosPDV']['Cargo']); ?>&nbsp;</td>
                                ...
                                <div class="pull-right">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu">
                                            <li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $funcionario['FuncionariosPDV']['Id'])), array('escape' => false)); ?></li>
                                            <li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $funcionario['FuncionariosPDV']['Id'])), array('escape' => false)); ?></li>
                                            <li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $funcionario['FuncionariosPDV']['Id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $funcionario['FuncionariosPDV']['Id']),array('class' => 'btn btn-mini'));?> </li>
                                        </ul>
                                    </div>
                                </div>
                            </td>
