<section class="content-header">
    <h1>
        <?php echo __('Revisors'); ?>
        <small><?php echo __('All Registered'); ?></small>
    </h1>
    <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Revisors'));
                	...
                	<thead>
                	   <tr>
                    	<th><?php echo $this->Paginator->sort('Id',__('Id'),array('data-toggle'=>'tooltip','data-original-title'=>__('Id'),'title'=>__('Id'))); ?></th>
                            ...
                            <th><?php echo $this->Paginator->sort('Item_Novo',__('Item_Novo'),array('data-toggle'=>'tooltip','data-original-title'=>__('Item_Novo'),'title'=>__('Item_Novo'))); ?></th>
...
<td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
						...
						<tr>
						<td><?php echo h($revisor['Revisor']['Id']); ?>&nbsp;</td>
						...
						<td><?php echo h($revisor['Revisor']['Removed']); ?>&nbsp;</td>
						<td><?php echo h($revisor['Revisor']['Created']); ?>&nbsp;</td>
						<td><?php echo h($revisor['Revisor']['Modified']); ?>&nbsp;</td>
