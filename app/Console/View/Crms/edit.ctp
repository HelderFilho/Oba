<section class="content-header">
    <h1>
        <?php echo __('Crms'); ?>
        <small><?php echo __('Edit').' '.__('Crm'); ?></small>
    </h1>
     <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Crms'),'/Crms');
              $this->Html->addCrumb(__('Edit').' '.__('Crm'));
            echo $this->Html->getCrumbList(['class'=>'breadcrumb','lastClass'=>'active']);?>
</section>
<div class="crms form" style="margin: 20px" >
<?php echo $this->Form->create('Crm'); ?>
    <fieldset>
            ...
            <div class="row">
                <div class="div'=>'col-sm-12 col-md-7 col-xs-12">
                    <div style="margin: 20px">
					 ...
					 echo $this->Html->div('row',$this->Form->input('Quantidade',array('div'=>'col-xs-12','data-toggle'=>'tooltip','data-original-title'=>__('Quantidade'),'title'=>__('Quantidade'),'class'=>'form-control input-sm')),array('escape'=>false));
					 echo $this->Html->div('row',$this->Form->input('Cupom',array('div'=>'col-xs-12','data-toggle'=>'tooltip','data-original-title'=>__('Cupom'),'title'=>__('Cupom'),'class'=>'form-control input-sm')),array('escape'=>false));
					 echo $this->Html->div('row',$this->Form->input('Valor',array('div'=>'col-xs-12','data-toggle'=>'tooltip','data-original-title'=>__('Valor'),'title'=>__('Valor'),'class'=>'form-control input-sm')),array('escape'=>false));
					 ...
					 echo $this->Html->div('row',$this->Form->input('Nascimento',array('div'=>'col-xs-12','data-toggle'=>'tooltip','data-original-title'=>__('Nascimento'),'title'=>__('Nascimento'),'class'=>'form-control input-sm')),array('escape'=>false));
				?>
                    </div>
                </div>
            </div>
