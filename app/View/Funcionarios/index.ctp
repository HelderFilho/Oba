<section class="content-header">
    ...
    <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Funcionarios'));
            echo $this->Html->getCrumbList(['class'=>'breadcrumb','lastClass'=>'active']);?>
    
</section>
<div class="funcionarios index" style="margin: 20px" >
        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	...
                	<tbody>
                	    <tr>
                    	    <?php $base_url = array('controller' => 'Funcionarios', 'action' => 'index');?>
                     ...
                     <td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
                        ...
                        <td><?php echo h($funcionario['Funcionario']['Caracteristicas']); ?>&nbsp;</td>
						<td><?php echo h($funcionario['Funcionario']['Endereco']); ?>&nbsp;</td>
			            <td><?php echo h($funcionario['Funcionario']['Equipe']); ?>&nbsp;</td>
						...
						<td><?php echo h($funcionario['Funcionario']['Cargo']); ?>&nbsp;</td>
                          <td><?php echo h($funcionario['Funcionario']['Item_Novo']); ?>&nbsp;</td>
                        <td><?php echo h($funcionario['Funcionario']['Data_Nascimento']); ?>&nbsp;</td>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $funcionario['Funcionario']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $funcionario['Funcionario']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $funcionario['Funcionario']['Id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $funcionario['Funcionario']['Id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
