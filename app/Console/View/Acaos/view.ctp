...
<div class="panel panel-default" style="margin: 20px">
    ...
    <div class="nav-tabs-custom">
		...
		<dd><?php echo h($acao['Acao']['Id']); ?></dd>
		<?php }?>
		<?php if($acao['Acao']['Nome']){?>
		<dt><?php echo __('Nome'); ?></dt>
		<dd><?php echo h($acao['Acao']['Nome']); ?></dd>
		<?php }?>
		<?php if($acao['Acao']['Local']){?>
		<dt><?php echo __('Local'); ?></dt>
		<dd><?php echo h($acao['Acao']['Local']); ?></dd>
		<?php }?>
		...
		<?php }?>
		<?php if($acao['Acao']['Fotos']){?>
		<dt><?php echo __('Fotos'); ?></dt>
		<dd><?php echo h($acao['Acao']['Fotos']); ?></dd>
		<?php }?>
		<?php if($acao['Acao']['Videos']){?>
		<dt><?php echo __('Videos'); ?></dt>
		<dd><?php echo h($acao['Acao']['Videos']); ?></dd>
		<?php }?>
		<?php if($acao['Acao']['Removed']){?>
		<dt><?php echo __('Removed'); ?></dt>
		<dd><?php echo h($acao['Acao']['Removed']); ?></dd>
		<?php }?>
		<?php if($acao['Acao']['Created']){?>
		<dt><?php echo __('Created'); ?></dt>
		<dd><?php echo h($acao['Acao']['Created']); ?></dd>
		<?php }?>
		<?php if($acao['Acao']['Modified']){?>
		<dt><?php echo __('Modified'); ?></dt>
		<dd><?php echo h($acao['Acao']['Modified']); ?></dd>
		<?php }?>
                </div>
            </div>
                        </div>
