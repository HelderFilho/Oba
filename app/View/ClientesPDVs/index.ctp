...
<div class="ClientesPDVs index" style="margin: 20px" >
                ...
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                    <thead>
                       <tr>
                            ...
                            <th style= text-align:center><?php echo $this->Paginator->sort('Razao_Social',__('Razao_Social'),array('data-toggle'=>'tooltip','data-original-title'=>__('Razao_Social'),'title'=>__('Razao_Social'))); ?></th>
                            <th style= text-align:center><?php echo $this->Paginator->sort('Nome_Fantasia',__('Nome_Fantasia'),array('data-toggle'=>'tooltip','data-original-title'=>__('Nome_Fantasia'),'title'=>__('Nome_Fantasia'))); ?></th>
                    ...
                    <tbody>
                        <tr>
                            <?php $base_url = array('controller' => 'ClientesPDVs', 'action' => 'index');?>
                    ...
                    <td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
                        ...
                        <?php foreach ($ClientesPDV as $cliente): ?>
                        <tr>
                        <td><?php echo h($cliente['ClientesPDV']['CNPJ']); ?>&nbsp;</td>
                        <td><?php echo h($cliente['ClientesPDV']['Razao_Social']); ?>&nbsp;</td>
                        <td><?php echo h($cliente['ClientesPDV']['Nome_Fantasia']); ?>&nbsp;</td>
                        <td><?php echo h($cliente['ClientesPDV']['Endereco']); ?>&nbsp;</td>
                        <td><?php echo h($cliente['ClientesPDV']['Email']); ?>&nbsp;</td>
                        <td><?php echo h($cliente['ClientesPDV']['Telefone']); ?>&nbsp;</td>
                        <td><?php echo h($cliente['ClientesPDV']['Bairro']); ?>&nbsp;</td>
                        <td><?php echo h($cliente['ClientesPDV']['Cep']); ?>&nbsp;</td>
                        <td><?php echo h($cliente['ClientesPDV']['Cidade']); ?>&nbsp;</td>
                                ...
                                <div class="pull-right">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu">
                                            <li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $cliente['ClientesPDV']['Id'])), array('escape' => false)); ?></li>
                                            <li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $cliente['ClientesPDV']['Id'])), array('escape' => false)); ?></li>

                                           <li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $cliente['ClientesPDV']['Id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $cliente['ClientesPDV']['Id']),array('class' => 'btn btn-mini'));?> </li>
                                        </ul>
                                    </div>
