        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        <tr>
                            <?php $base_url = array('controller' => 'EquipePDV', 'action' => 'index');?>
                    ...
                    <td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
                        ...
                        <tr>
                        <td><?php echo h($equipe['EquipePDV']['Nome']); ?>&nbsp;</td>
                                ...
                                <div class="pull-right">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu">
                                            <li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $equipe['EquipePDV']['Id'])), array('escape' => false)); ?></li>
                                            <li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $equipe['EquipePDV']['Id'])), array('escape' => false)); ?></li>
                                            <li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $equipe['EquipePDV']['Id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $equipe['EquipePDV']['Id']),array('class' => 'btn btn-mini'));?> </li>
                                        </ul>
                                    </div>
                                </div>
                            </td>
