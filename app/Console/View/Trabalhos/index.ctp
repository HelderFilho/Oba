<section class="content-header">
    ...
    <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Trabalhos'));
            echo $this->Html->getCrumbList(['class'=>'breadcrumb','lastClass'=>'active']);?>
    
</section>
<div class="trabalhos index" style="margin: 20px" >
        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	<thead>
                	   <tr>
                    	<th><?php echo $this->Paginator->sort('Id',__('Id'),array('data-toggle'=>'tooltip','data-original-title'=>__('Id'),'title'=>__('Id'))); ?></th>
                            ...
                            <th><?php echo $this->Paginator->sort('Situacao',__('Situacao'),array('data-toggle'=>'tooltip','data-original-title'=>__('Situacao'),'title'=>__('Situacao'))); ?></th>
                	...
                	<tbody>
                	    <tr>
                    	    <?php $base_url = array('controller' => 'Trabalhos', 'action' => 'index');?>
					 ...
					 <td><?php echo $this->Html->div('row',$this->Form->input('Situacao',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Situacao'),'title'=>__('Situacao'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
...
<td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
						...
						<tr>
						<td><?php echo h($trabalho['Trabalho']['Id']); ?>&nbsp;</td>
						<td><?php echo h($trabalho['Trabalho']['Funcionarios']); ?>&nbsp;</td>
						<td><?php echo h($trabalho['Trabalho']['Local']); ?>&nbsp;</td>
						<td><?php echo h($trabalho['Trabalho']['Situacao']); ?>&nbsp;</td>
						<td><?php echo h($trabalho['Trabalho']['Removed']); ?>&nbsp;</td>
						<td><?php echo h($trabalho['Trabalho']['Created']); ?>&nbsp;</td>
						<td><?php echo h($trabalho['Trabalho']['Modified']); ?>&nbsp;</td>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $trabalho['Trabalho']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $trabalho['Trabalho']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $trabalho['Trabalho']['Id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $trabalho['Trabalho']['Id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
