...
class UsersController extends AdminAppController
{
	...
	public function nomesUsuarios(){
	return	$this->User->find('list', array(
        'fields' => array('User.Id',"User.Name"),
        'conditions' =>array('User.removed'=>'N')
    ));
	}
	...
	return	$this->User->find('list', array(
        'fields' => array('User.Id',"User.Name"),
        'conditions' =>array('User.removed'=>'N', 'User.group_id'=>2)
    ));
	}
	public function nomesSupervisores(){
	return	$this->User->find('list', array(
        'fields' => array('User.Id',"User.Name"),
        'conditions' =>array('User.removed'=>'N', 'User.group_id'=>3)
    ));
	}
	

	public function retornaToken($id=0){
	...
	public function admin_add()
	{
		if ( !empty( $this->request->data ) ) {
			$this->User->create();			
			$this->request->data['User']['pass_mob'] = $this->request->data['User']['password'];
